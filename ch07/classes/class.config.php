<?php # Script 7.1 - class.config.php

	// This page defines a Config class which uses the Singleton pattern.

	/* The Config class.
	 * The class contains two attributes: $_instance and $_settings
