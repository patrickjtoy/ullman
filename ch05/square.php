...
<html lang="en">
	...
	<body>
		<?php # Script 5.2 - square.php
			...
			require('../ch04/rectangle.class.php');
			...
			// Print the area:
			echo '<p>The perimeter of the rectangle is ' . $r->getArea() . '</p>';

			// Print the perimeter:
			echo '<p>The perimete of the rectangle is ' . $r->getPerimeter() . '</p>';
			...
			// Print the perimeter:
			echo '<p>The perimete of the square is ' . $s->getPerimeter() . '</p>';
